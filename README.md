...
Video editing with server-side rendering export via CE.SDK Renderer. Built with [CE.SDK](https://img.ly/creative-sdk) by [IMG.LY], this starterkit demonstrates how to export videos using the CE.SDK Renderer service for server-side rendering.

<p>
  <a href="https://img.ly/docs/cesdk/starterkits/export-using-renderer/">Documentation</a> |
...
│       ├── renderer.ts       # Server-side renderer export logic
│       └── config/
